...
public class CustomerRepository implements ICustomerRepository{
    ...
    private static final String SELECT_ALL = "select * from customer join customer_type on customer_type.customer_type_id= customer.customer_type_id where status=0;";
