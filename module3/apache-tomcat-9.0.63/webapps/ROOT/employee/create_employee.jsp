    ...
    <div class="bg-pink text-white col-5" style="margin: 0 auto !important; padding: 20px;">
        <form method="post">
            ...
            <div class="form-outline mb-1 w-75">
                ...
                <input type="text" id="form1Example4" class="form-control" name="idCard"/>
            </div>

            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example4">Employee Salary</label>
                <input type="text" id="form1Example5" class="form-control" name="salary"/>
            ...
            <div class="form-outline mb-1 w-75">
                ...
                <select class="form-select" aria-label="Default select example" id="form1Example9" name="employeePosition">
            ...
            <div class="form-outline mb-1 w-75">
                ...
                <select class="form-select" aria-label="Default select example" id="form1Example10" name="educationDegree">
                    <option selected disabled>Choice Education Degree</option>
            ...
            <div class="form-outline mb-1 w-75">
                ...
                <select class="form-select" aria-label="Default select example" id="form1Example11" name="division">
                    <option selected disabled>Choice Division Employee</option>
            ...
            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example2">User</label>
