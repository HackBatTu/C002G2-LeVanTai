...
<div class="col-auto row col-12" style="margin: 0 auto;">
    <div class="bg-pink text-white col-5" style="margin: 0 auto !important; padding: 20px;">
        <form method="post">
            ...
            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example2">Area</label>
                <input type="text" id="form1Example2" class="form-control" name="area" value="${area}"/>
            </div>

            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example3">Cost Service</label>
                <input type="text" id="form1Example3" class="form-control" name="cost" value="${cost}"/>
            </div>

            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example4">maxPerson</label>
                <input type="text" id="form1Example4" class="form-control" name="maxPerson"  value="${maxPerson}"/>

            </div>
            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example5">roomStandard</label>
                <input type="text" id="form1Example5" class="form-control" name="roomStandard" value="${roomStandard}"/>
            </div>

            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example6">anotherConvenient</label>
                <input type="text" id="form1Example6" class="form-control" name="anotherConvenient" value="${anotherConvenient}"/>
            </div>

            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example7">poolArea</label>
                <input type="text" id="form1Example7" class="form-control" name="poolArea" value="${poolArea}"/>
            </div>
            <div class="form-outline mb-1 w-75">
                <label class="form-label" for="form1Example8">numOfFloors</label>
                <input type="text" id="form1Example8" class="form-control" name="numOfFloors" value="${numOfFloors}"/>
            </div>
            <div class="form-outline mb-2 w-75">
                <label class="form-label" for="form1Example9">RentType</label>
                <select class="form-select" aria-label="Default select example" id="form1Example9"
                        name="rentType">
                    <c:forEach items="${rentTypeList}" var="i">
                        <c:choose>
                            <c:when test="${i.id == rentTypeId}">
            ...
            <div class="form-outline mb-2 w-75">
                ...
                <select class="form-select" aria-label="Default select example" id="form1Example10"
                    ...
                    <c:forEach items="${serviceTypeList}" var="i">
                        <c:choose>
                            <c:when test="${i.id == serviceTypeId}">
                                <option value="${i.id}" selected>${i.name}</option>
                            </c:when>
                            <c:otherwise>
                                <option value="${i.id}">${i.name}</option>
