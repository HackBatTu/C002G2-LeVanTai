...
//    : Tiêu chuẩn phòng, Số tầng.
    ...
    public House(String idFacility, String serviceName, Integer area, Integer rentalCosts, Integer maxPerson, String rentalType, String roomStandard, Integer numberOfFloors) {
