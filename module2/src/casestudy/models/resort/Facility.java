...
//    Tên dịch vụ, Diện tích sử dụng, Chi phí thuê, Số lượng người tối đa, Kiểu thuê (bao gồm thuê theo năm, tháng, ngày, giờ)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(serviceName, facility.serviceName) && Objects.equals(idFacility,facility.idFacility);
    }

    @Override
    public int hashCode() {
        return Objects.hash(serviceName,idFacility);
    }
